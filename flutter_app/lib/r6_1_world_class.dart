...
class R61HomeDashboard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => R8HomeLobby(controller: controller, onTab: onTab);
}
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: <Widget>[
        ...
        if (online.isEmpty)
          PremiumPanel(child: Padding(padding: const EdgeInsets.all(20), child: Center(child: Text(ar ? 'لا يوجد أصدقاء متصلون الآن.' : 'No friends online right now.'))))
        else
