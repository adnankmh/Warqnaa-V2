...
const String warqnaAppVersion = String.fromEnvironment('WARQNA_APP_VERSION', defaultValue: '1.1.1');
const int warqnaAppBuild = int.fromEnvironment('WARQNA_APP_BUILD', defaultValue: 301);
