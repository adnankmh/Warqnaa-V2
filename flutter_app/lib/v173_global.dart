...
const List<PashaStyleV173> pashaStylesV173 = <PashaStyleV173>[
  PashaStyleV173('yellow', 'أصفر', 'Yellow', '#f6c915', '#9b6d00', 'assets/optimized/r10/pasha/v173/pasha_yellow.webp'),
  PashaStyleV173('red', 'أحمر', 'Red', '#b70822', '#6f0012', 'assets/optimized/r10/pasha/v173/pasha_red.webp'),
  PashaStyleV173('crimson', 'قرمزي', 'Crimson', '#c1123f', '#74001f', 'assets/optimized/r10/pasha/v173/pasha_red.webp'),
  PashaStyleV173('blue', 'أزرق', 'Blue', '#1e55b5', '#0b2a70', 'assets/optimized/r10/pasha/v173/pasha_blue.webp'),
  PashaStyleV173('green', 'أخضر', 'Green', '#006b58', '#00382f', 'assets/optimized/r10/pasha/v173/pasha_green.webp'),
  PashaStyleV173('purple', 'بنفسجي', 'Purple', '#7b318b', '#45164e', 'assets/optimized/r10/pasha/v173/pasha_purple.webp'),
  PashaStyleV173('bronze', 'برونزي', 'Bronze', '#b57b38', '#68401d', 'assets/optimized/r10/pasha/v173/pasha_bronze.webp'),
  PashaStyleV173('gold', 'ذهبي', 'Gold', '#d79d31', '#7b4e0c', 'assets/optimized/r10/pasha/v173/pasha_gold.webp'),
  PashaStyleV173('orange', 'برتقالي', 'Orange', '#ff6515', '#a32d00', 'assets/optimized/r10/pasha/v173/pasha_orange.webp'),
  PashaStyleV173('pink', 'وردي', 'Pink', '#e42f8a', '#8a104a', 'assets/optimized/r10/pasha/v173/pasha_pink.webp'),
  PashaStyleV173('silver', 'فضي', 'Silver', '#c9ccd2', '#737883', 'assets/optimized/r10/pasha/v173/pasha_silver.webp'),
  PashaStyleV173('platinum', 'بلاتيني', 'Platinum', '#e0e4e9', '#8d96a3', 'assets/optimized/r10/pasha/v173/pasha_platinum.webp'),
  PashaStyleV173('navy', 'كحلي', 'Navy', '#16265e', '#091333', 'assets/optimized/r10/pasha/v173/pasha_navy.webp'),
  PashaStyleV173('white', 'أبيض', 'White', '#f2f3f5', '#aeb4bd', 'assets/optimized/r10/pasha/v173/pasha_white.webp'),
];
...
List<StoreProduct> buildV173StoreProducts() => <StoreProduct>[
    StoreProduct(id: 'pasha_style_yellow_v173', category: 'pasha_style', icon: '👑', nameAr: 'طربوش باشا أصفر', nameEn: 'Yellow Pasha Fez', descriptionAr: 'هوية باشا كاملة باللون أصفر: الطربوش والوهج والاسم والدردشة واللون الرئيسي.', descriptionEn: 'Full yellow Pasha identity: fez, glow, name, chat and accent color.', price: 6500, value: 'yellow', previewColor1: Color(0xfff6c915), previewColor2: Color(0xff9b6d00), imageAsset: 'assets/optimized/r10/pasha/v173/pasha_yellow.webp', collection: 'pasha_v173'),
    StoreProduct(id: 'pasha_style_red_v173', category: 'pasha_style', icon: '👑', nameAr: 'طربوش باشا أحمر', nameEn: 'Red Pasha Fez', descriptionAr: 'هوية باشا كاملة باللون أحمر: الطربوش والوهج والاسم والدردشة واللون الرئيسي.', descriptionEn: 'Full red Pasha identity: fez, glow, name, chat and accent color.', price: 6500, value: 'red', previewColor1: Color(0xffb70822), previewColor2: Color(0xff6f0012), imageAsset: 'assets/optimized/r10/pasha/v173/pasha_red.webp', collection: 'pasha_v173'),
    StoreProduct(id: 'pasha_style_crimson_v173', category: 'pasha_style', icon: '👑', nameAr: 'طربوش باشا قرمزي', nameEn: 'Crimson Pasha Fez', descriptionAr: 'هوية باشا كاملة باللون القرمزي: الطربوش والوهج والاسم والدردشة واللون الرئيسي.', descriptionEn: 'Full crimson Pasha identity: fez, glow, name, chat and accent color.', price: 6500, value: 'crimson', previewColor1: Color(0xffc1123f), previewColor2: Color(0xff74001f), imageAsset: 'assets/optimized/r10/pasha/v173/pasha_red.webp', collection: 'pasha_v173'),
    StoreProduct(id: 'pasha_style_blue_v173', category: 'pasha_style', icon: '👑', nameAr: 'طربوش باشا أزرق', nameEn: 'Blue Pasha Fez', descriptionAr: 'هوية باشا كاملة باللون أزرق: الطربوش والوهج والاسم والدردشة واللون الرئيسي.', descriptionEn: 'Full blue Pasha identity: fez, glow, name, chat and accent color.', price: 6500, value: 'blue', previewColor1: Color(0xff1e55b5), previewColor2: Color(0xff0b2a70), imageAsset: 'assets/optimized/r10/pasha/v173/pasha_blue.webp', collection: 'pasha_v173'),
    StoreProduct(id: 'pasha_style_green_v173', category: 'pasha_style', icon: '👑', nameAr: 'طربوش باشا أخضر', nameEn: 'Green Pasha Fez', descriptionAr: 'هوية باشا كاملة باللون أخضر: الطربوش والوهج والاسم والدردشة واللون الرئيسي.', descriptionEn: 'Full green Pasha identity: fez, glow, name, chat and accent color.', price: 6500, value: 'green', previewColor1: Color(0xff006b58), previewColor2: Color(0xff00382f), imageAsset: 'assets/optimized/r10/pasha/v173/pasha_green.webp', collection: 'pasha_v173'),
    StoreProduct(id: 'pasha_style_purple_v173', category: 'pasha_style', icon: '👑', nameAr: 'طربوش باشا بنفسجي', nameEn: 'Purple Pasha Fez', descriptionAr: 'هوية باشا كاملة باللون بنفسجي: الطربوش والوهج والاسم والدردشة واللون الرئيسي.', descriptionEn: 'Full purple Pasha identity: fez, glow, name, chat and accent color.', price: 6500, value: 'purple', previewColor1: Color(0xff7b318b), previewColor2: Color(0xff45164e), imageAsset: 'assets/optimized/r10/pasha/v173/pasha_purple.webp', collection: 'pasha_v173'),
    StoreProduct(id: 'pasha_style_bronze_v173', category: 'pasha_style', icon: '👑', nameAr: 'طربوش باشا برونزي', nameEn: 'Bronze Pasha Fez', descriptionAr: 'هوية باشا كاملة باللون برونزي: الطربوش والوهج والاسم والدردشة واللون الرئيسي.', descriptionEn: 'Full bronze Pasha identity: fez, glow, name, chat and accent color.', price: 6500, value: 'bronze', previewColor1: Color(0xffb57b38), previewColor2: Color(0xff68401d), imageAsset: 'assets/optimized/r10/pasha/v173/pasha_bronze.webp', collection: 'pasha_v173'),
    StoreProduct(id: 'pasha_style_gold_v173', category: 'pasha_style', icon: '👑', nameAr: 'طربوش باشا ذهبي', nameEn: 'Gold Pasha Fez', descriptionAr: 'هوية باشا كاملة باللون ذهبي: الطربوش والوهج والاسم والدردشة واللون الرئيسي.', descriptionEn: 'Full gold Pasha identity: fez, glow, name, chat and accent color.', price: 6500, value: 'gold', previewColor1: Color(0xffd79d31), previewColor2: Color(0xff7b4e0c), imageAsset: 'assets/optimized/r10/pasha/v173/pasha_gold.webp', collection: 'pasha_v173'),
    StoreProduct(id: 'pasha_style_orange_v173', category: 'pasha_style', icon: '👑', nameAr: 'طربوش باشا برتقالي', nameEn: 'Orange Pasha Fez', descriptionAr: 'هوية باشا كاملة باللون برتقالي: الطربوش والوهج والاسم والدردشة واللون الرئيسي.', descriptionEn: 'Full orange Pasha identity: fez, glow, name, chat and accent color.', price: 6500, value: 'orange', previewColor1: Color(0xffff6515), previewColor2: Color(0xffa32d00), imageAsset: 'assets/optimized/r10/pasha/v173/pasha_orange.webp', collection: 'pasha_v173'),
    StoreProduct(id: 'pasha_style_pink_v173', category: 'pasha_style', icon: '👑', nameAr: 'طربوش باشا وردي', nameEn: 'Pink Pasha Fez', descriptionAr: 'هوية باشا كاملة باللون وردي: الطربوش والوهج والاسم والدردشة واللون الرئيسي.', descriptionEn: 'Full pink Pasha identity: fez, glow, name, chat and accent color.', price: 6500, value: 'pink', previewColor1: Color(0xffe42f8a), previewColor2: Color(0xff8a104a), imageAsset: 'assets/optimized/r10/pasha/v173/pasha_pink.webp', collection: 'pasha_v173'),
    StoreProduct(id: 'pasha_style_silver_v173', category: 'pasha_style', icon: '👑', nameAr: 'طربوش باشا فضي', nameEn: 'Silver Pasha Fez', descriptionAr: 'هوية باشا كاملة باللون فضي: الطربوش والوهج والاسم والدردشة واللون الرئيسي.', descriptionEn: 'Full silver Pasha identity: fez, glow, name, chat and accent color.', price: 6500, value: 'silver', previewColor1: Color(0xffc9ccd2), previewColor2: Color(0xff737883), imageAsset: 'assets/optimized/r10/pasha/v173/pasha_silver.webp', collection: 'pasha_v173'),
    StoreProduct(id: 'pasha_style_platinum_v173', category: 'pasha_style', icon: '👑', nameAr: 'طربوش باشا بلاتيني', nameEn: 'Platinum Pasha Fez', descriptionAr: 'هوية باشا كاملة باللون بلاتيني: الطربوش والوهج والاسم والدردشة واللون الرئيسي.', descriptionEn: 'Full platinum Pasha identity: fez, glow, name, chat and accent color.', price: 6500, value: 'platinum', previewColor1: Color(0xffe0e4e9), previewColor2: Color(0xff8d96a3), imageAsset: 'assets/optimized/r10/pasha/v173/pasha_platinum.webp', collection: 'pasha_v173'),
    StoreProduct(id: 'pasha_style_navy_v173', category: 'pasha_style', icon: '👑', nameAr: 'طربوش باشا كحلي', nameEn: 'Navy Pasha Fez', descriptionAr: 'هوية باشا كاملة باللون كحلي: الطربوش والوهج والاسم والدردشة واللون الرئيسي.', descriptionEn: 'Full navy Pasha identity: fez, glow, name, chat and accent color.', price: 6500, value: 'navy', previewColor1: Color(0xff16265e), previewColor2: Color(0xff091333), imageAsset: 'assets/optimized/r10/pasha/v173/pasha_navy.webp', collection: 'pasha_v173'),
    StoreProduct(id: 'pasha_style_white_v173', category: 'pasha_style', icon: '👑', nameAr: 'طربوش باشا أبيض', nameEn: 'White Pasha Fez', descriptionAr: 'هوية باشا كاملة باللون أبيض: الطربوش والوهج والاسم والدردشة واللون الرئيسي.', descriptionEn: 'Full white Pasha identity: fez, glow, name, chat and accent color.', price: 6500, value: 'white', previewColor1: Color(0xfff2f3f5), previewColor2: Color(0xffaeb4bd), imageAsset: 'assets/optimized/r10/pasha/v173/pasha_white.webp', collection: 'pasha_v173'),
    StoreProduct(id: 'table_v173_royal_01', category: 'tables', icon: '🃏', nameAr: 'طاولة الزمرد الملكي', nameEn: 'Royal Collection 01 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 12000, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_01.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_02', category: 'tables', icon: '🃏', nameAr: 'طاولة المخمل القرمزي', nameEn: 'Royal Collection 02 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 12850, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_02.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_03', category: 'tables', icon: '🃏', nameAr: 'طاولة المحيط الأزرق', nameEn: 'Royal Collection 03 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 13700, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_03.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_04', category: 'tables', icon: '🃏', nameAr: 'طاولة الليل الذهبي', nameEn: 'Royal Collection 04 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 14550, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_04.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_05', category: 'tables', icon: '🃏', nameAr: 'طاولة البنفسج الإمبراطوري', nameEn: 'Royal Collection 05 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 15400, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_05.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_06', category: 'tables', icon: '🃏', nameAr: 'طاولة الغابة العميقة', nameEn: 'Royal Collection 06 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 16250, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_06.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_07', category: 'tables', icon: '🃏', nameAr: 'طاولة البرونز العتيق', nameEn: 'Royal Collection 07 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 17100, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_07.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_08', category: 'tables', icon: '🃏', nameAr: 'طاولة الياقوت الأحمر', nameEn: 'Royal Collection 08 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 17950, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_08.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_09', category: 'tables', icon: '🃏', nameAr: 'طاولة الفيروز الفاخر', nameEn: 'Royal Collection 09 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 18800, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_09.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_10', category: 'tables', icon: '🃏', nameAr: 'طاولة الفضة الملكية', nameEn: 'Royal Collection 10 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 19650, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_10.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_11', category: 'tables', icon: '🃏', nameAr: 'طاولة الأسد الذهبي', nameEn: 'Royal Collection 11 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 20500, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_11.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_12', category: 'tables', icon: '🃏', nameAr: 'طاولة النمر الملكي', nameEn: 'Royal Collection 12 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 21350, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_12.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_13', category: 'tables', icon: '🃏', nameAr: 'طاولة الحصان الأسود', nameEn: 'Royal Collection 13 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 22200, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_13.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_14', category: 'tables', icon: '🃏', nameAr: 'طاولة الصقر الجبلي', nameEn: 'Royal Collection 14 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 23050, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_14.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_15', category: 'tables', icon: '🃏', nameAr: 'طاولة الذئب الأزرق', nameEn: 'Royal Collection 15 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 23900, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_15.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_16', category: 'tables', icon: '🃏', nameAr: 'طاولة التنين الناري', nameEn: 'Royal Collection 16 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 24750, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_16.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_17', category: 'tables', icon: '🃏', nameAr: 'طاولة العقاب الفضي', nameEn: 'Royal Collection 17 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 25600, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_17.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_18', category: 'tables', icon: '🃏', nameAr: 'طاولة الفهد الليلي', nameEn: 'Royal Collection 18 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 26450, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_18.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_19', category: 'tables', icon: '🃏', nameAr: 'طاولة القرش الأزرق', nameEn: 'Royal Collection 19 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 27300, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_19.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_20', category: 'tables', icon: '🃏', nameAr: 'طاولة الحوت العميق', nameEn: 'Royal Collection 20 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 28150, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_20.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_21', category: 'tables', icon: '🃏', nameAr: 'طاولة السباق الأسود', nameEn: 'Royal Collection 21 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 29000, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_21.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_22', category: 'tables', icon: '🃏', nameAr: 'طاولة السيارة الحمراء', nameEn: 'Royal Collection 22 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 29850, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_22.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_23', category: 'tables', icon: '🃏', nameAr: 'طاولة العضلات الكلاسيكية', nameEn: 'Royal Collection 23 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 30700, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_23.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_24', category: 'tables', icon: '🃏', nameAr: 'طاولة السرعة الزرقاء', nameEn: 'Royal Collection 24 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 31550, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_24.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_25', category: 'tables', icon: '🃏', nameAr: 'طاولة الدراجة الخضراء', nameEn: 'Royal Collection 25 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 32400, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_25.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_26', category: 'tables', icon: '🃏', nameAr: 'طاولة الدراجة النارية', nameEn: 'Royal Collection 26 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 33250, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_26.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_27', category: 'tables', icon: '🃏', nameAr: 'طاولة البومة القمرية', nameEn: 'Royal Collection 27 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 34100, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_27.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_28', category: 'tables', icon: '🃏', nameAr: 'طاولة الذئب الثلجي', nameEn: 'Royal Collection 28 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 34950, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_28.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_29', category: 'tables', icon: '🃏', nameAr: 'طاولة التنين الذهبي', nameEn: 'Royal Collection 29 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 35800, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_29.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_royal_30', category: 'tables', icon: '🃏', nameAr: 'طاولة العنقاء النارية', nameEn: 'Royal Collection 30 Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 36650, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/royal/table_v173_royal_30.webp', collection: 'v173_royal'),
    StoreProduct(id: 'table_v173_showcase_01', category: 'tables', icon: '🃏', nameAr: 'طاولة الأسد الملكي', nameEn: 'Royal Lion Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 28000, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/showcase/table_v173_showcase_01.webp', collection: 'v173_showcase'),
    StoreProduct(id: 'table_v173_showcase_02', category: 'tables', icon: '🃏', nameAr: 'طاولة النمر الأبيض', nameEn: 'White Tiger Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 29500, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/showcase/table_v173_showcase_02.webp', collection: 'v173_showcase'),
    StoreProduct(id: 'table_v173_showcase_03', category: 'tables', icon: '🃏', nameAr: 'طاولة الحصان الأسود', nameEn: 'Black Stallion Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 31000, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/showcase/table_v173_showcase_03.webp', collection: 'v173_showcase'),
    StoreProduct(id: 'table_v173_showcase_04', category: 'tables', icon: '🃏', nameAr: 'طاولة العقاب الجبلي', nameEn: 'Mountain Eagle Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 32500, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/showcase/table_v173_showcase_04.webp', collection: 'v173_showcase'),
    StoreProduct(id: 'table_v173_showcase_05', category: 'tables', icon: '🃏', nameAr: 'طاولة النمر الناري', nameEn: 'Fire Tiger Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 34000, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/showcase/table_v173_showcase_05.webp', collection: 'v173_showcase'),
    StoreProduct(id: 'table_v173_showcase_06', category: 'tables', icon: '🃏', nameAr: 'طاولة القرش الأزرق', nameEn: 'Blue Shark Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 35500, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/showcase/table_v173_showcase_06.webp', collection: 'v173_showcase'),
    StoreProduct(id: 'table_v173_showcase_07', category: 'tables', icon: '🃏', nameAr: 'طاولة الحوت العميق', nameEn: 'Deep Whale Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 37000, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/showcase/table_v173_showcase_07.webp', collection: 'v173_showcase'),
    StoreProduct(id: 'table_v173_showcase_08', category: 'tables', icon: '🃏', nameAr: 'طاولة الفهد الأسود', nameEn: 'Black Panther Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 38500, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/showcase/table_v173_showcase_08.webp', collection: 'v173_showcase'),
    StoreProduct(id: 'table_v173_showcase_09', category: 'tables', icon: '🃏', nameAr: 'طاولة السيارة السوداء', nameEn: 'Black Supercar Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 40000, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/showcase/table_v173_showcase_09.webp', collection: 'v173_showcase'),
    StoreProduct(id: 'table_v173_showcase_10', category: 'tables', icon: '🃏', nameAr: 'طاولة السيارة الحمراء', nameEn: 'Red Supercar Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 41500, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/showcase/table_v173_showcase_10.webp', collection: 'v173_showcase'),
    StoreProduct(id: 'table_v173_showcase_11', category: 'tables', icon: '🃏', nameAr: 'طاولة السيارة الكلاسيكية', nameEn: 'Classic Muscle Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 43000, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/showcase/table_v173_showcase_11.webp', collection: 'v173_showcase'),
    StoreProduct(id: 'table_v173_showcase_12', category: 'tables', icon: '🃏', nameAr: 'طاولة السيارة الزرقاء', nameEn: 'Blue Hypercar Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 44500, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/showcase/table_v173_showcase_12.webp', collection: 'v173_showcase'),
    StoreProduct(id: 'table_v173_showcase_13', category: 'tables', icon: '🃏', nameAr: 'طاولة الدراجة الخضراء', nameEn: 'Green Superbike Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 46000, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/showcase/table_v173_showcase_13.webp', collection: 'v173_showcase'),
    StoreProduct(id: 'table_v173_showcase_14', category: 'tables', icon: '🃏', nameAr: 'طاولة الدراجة الحمراء', nameEn: 'Red Superbike Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 47500, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/showcase/table_v173_showcase_14.webp', collection: 'v173_showcase'),
    StoreProduct(id: 'table_v173_showcase_15', category: 'tables', icon: '🃏', nameAr: 'طاولة البومة القمرية', nameEn: 'Moon Owl Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 49000, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/showcase/table_v173_showcase_15.webp', collection: 'v173_showcase'),
    StoreProduct(id: 'table_v173_showcase_16', category: 'tables', icon: '🃏', nameAr: 'طاولة الذئب الأبيض', nameEn: 'White Wolf Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 50500, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/showcase/table_v173_showcase_16.webp', collection: 'v173_showcase'),
    StoreProduct(id: 'table_v173_showcase_17', category: 'tables', icon: '🃏', nameAr: 'طاولة التنين الناري', nameEn: 'Fire Dragon Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 52000, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/showcase/table_v173_showcase_17.webp', collection: 'v173_showcase'),
    StoreProduct(id: 'table_v173_showcase_18', category: 'tables', icon: '🃏', nameAr: 'طاولة التنين الذهبي', nameEn: 'Golden Dragon Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 53500, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/showcase/table_v173_showcase_18.webp', collection: 'v173_showcase'),
    StoreProduct(id: 'table_v173_showcase_19', category: 'tables', icon: '🃏', nameAr: 'طاولة الذئب الأزرق', nameEn: 'Blue Wolf Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 55000, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/showcase/table_v173_showcase_19.webp', collection: 'v173_showcase'),
    StoreProduct(id: 'table_v173_showcase_20', category: 'tables', icon: '🃏', nameAr: 'طاولة العنقاء النارية', nameEn: 'Fire Phoenix Table', descriptionAr: 'طاولة Full HD من مجموعة V173 الجديدة مع معاينة كاملة داخل غرفة اللعب.', descriptionEn: 'Full-HD V173 table with full in-room preview.', price: 56500, previewColor1: const Color(0xff07111c), previewColor2: const Color(0xffd6aa59), imageAsset: 'assets/optimized/r10/tables/v173/showcase/table_v173_showcase_20.webp', collection: 'v173_showcase'),
    StoreProduct(id: 'competition_ticket_50_v173', category: 'competition_ticket', icon: '🎟️', nameAr: 'تذكرة منافسة 50 توكن', nameEn: '50 Token Competition Ticket', descriptionAr: 'تذكرة دخول للمنافسات حتى قيمة 50 توكن. سعر الشراء محدّث ضمن اقتصاد R9.1 مع بقاء قيمة التذكرة المطبوعة ثابتة.', descriptionEn: 'Competition entry ticket worth up to 50 tokens, with an R9.1 purchase price while its printed ticket value remains unchanged.', price: 45, value: '50', previewColor1: const Color(0xff6d28d9), previewColor2: const Color(0xfffacc15), collection: 'tickets_v173'),
    StoreProduct(id: 'competition_ticket_100_v173', category: 'competition_ticket', icon: '🎟️', nameAr: 'تذكرة منافسة 100 توكن', nameEn: '100 Token Competition Ticket', descriptionAr: 'تذكرة دخول للمنافسات حتى قيمة 100 توكن. سعر الشراء محدّث ضمن اقتصاد R9.1 مع بقاء قيمة التذكرة المطبوعة ثابتة.', descriptionEn: 'Competition entry ticket worth up to 100 tokens, with an R9.1 purchase price while its printed ticket value remains unchanged.', price: 90, value: '100', previewColor1: const Color(0xff6d28d9), previewColor2: const Color(0xfffacc15), collection: 'tickets_v173'),
    StoreProduct(id: 'competition_ticket_200_v173', category: 'competition_ticket', icon: '🎟️', nameAr: 'تذكرة منافسة 200 توكن', nameEn: '200 Token Competition Ticket', descriptionAr: 'تذكرة دخول للمنافسات حتى قيمة 200 توكن. سعر الشراء محدّث ضمن اقتصاد R9.1 مع بقاء قيمة التذكرة المطبوعة ثابتة.', descriptionEn: 'Competition entry ticket worth up to 200 tokens, with an R9.1 purchase price while its printed ticket value remains unchanged.', price: 180, value: '200', previewColor1: const Color(0xff6d28d9), previewColor2: const Color(0xfffacc15), collection: 'tickets_v173'),
    StoreProduct(id: 'competition_ticket_500_v173', category: 'competition_ticket', icon: '🎟️', nameAr: 'تذكرة منافسة 500 توكن', nameEn: '500 Token Competition Ticket', descriptionAr: 'تذكرة دخول للمنافسات حتى قيمة 500 توكن. سعر الشراء محدّث ضمن اقتصاد R9.1 مع بقاء قيمة التذكرة المطبوعة ثابتة.', descriptionEn: 'Competition entry ticket worth up to 500 tokens, with an R9.1 purchase price while its printed ticket value remains unchanged.', price: 450, value: '500', previewColor1: const Color(0xff6d28d9), previewColor2: const Color(0xfffacc15), collection: 'tickets_v173'),
    StoreProduct(id: 'competition_ticket_1000_v173', category: 'competition_ticket', icon: '🎟️', nameAr: 'تذكرة منافسة 1,000 توكن', nameEn: '1,000 Token Competition Ticket', descriptionAr: 'تذكرة دخول للمنافسات حتى قيمة 1,000 توكن. سعر الشراء محدّث ضمن اقتصاد R9.1 مع بقاء قيمة التذكرة المطبوعة ثابتة.', descriptionEn: 'Competition entry ticket worth up to 1,000 tokens, with an R9.1 purchase price while its printed ticket value remains unchanged.', price: 900, value: '1000', previewColor1: const Color(0xff6d28d9), previewColor2: const Color(0xfffacc15), collection: 'tickets_v173'),
    StoreProduct(id: 'competition_ticket_2000_v173', category: 'competition_ticket', icon: '🎟️', nameAr: 'تذكرة منافسة 2,000 توكن', nameEn: '2,000 Token Competition Ticket', descriptionAr: 'تذكرة دخول للمنافسات حتى قيمة 2,000 توكن. سعر الشراء محدّث ضمن اقتصاد R9.1 مع بقاء قيمة التذكرة المطبوعة ثابتة.', descriptionEn: 'Competition entry ticket worth up to 2,000 tokens, with an R9.1 purchase price while its printed ticket value remains unchanged.', price: 1800, value: '2000', previewColor1: const Color(0xff6d28d9), previewColor2: const Color(0xfffacc15), collection: 'tickets_v173'),
    StoreProduct(id: 'competition_ticket_4000_v173', category: 'competition_ticket', icon: '🎟️', nameAr: 'تذكرة منافسة 4,000 توكن', nameEn: '4,000 Token Competition Ticket', descriptionAr: 'تذكرة دخول للمنافسات حتى قيمة 4,000 توكن. سعر الشراء محدّث ضمن اقتصاد R9.1 مع بقاء قيمة التذكرة المطبوعة ثابتة.', descriptionEn: 'Competition entry ticket worth up to 4,000 tokens, with an R9.1 purchase price while its printed ticket value remains unchanged.', price: 3600, value: '4000', previewColor1: const Color(0xff6d28d9), previewColor2: const Color(0xfffacc15), collection: 'tickets_v173'),
    StoreProduct(id: 'competition_ticket_5000_v173', category: 'competition_ticket', icon: '🎟️', nameAr: 'تذكرة منافسة 5,000 توكن', nameEn: '5,000 Token Competition Ticket', descriptionAr: 'تذكرة دخول للمنافسات حتى قيمة 5,000 توكن. سعر الشراء محدّث ضمن اقتصاد R9.1 مع بقاء قيمة التذكرة المطبوعة ثابتة.', descriptionEn: 'Competition entry ticket worth up to 5,000 tokens, with an R9.1 purchase price while its printed ticket value remains unchanged.', price: 4500, value: '5000', previewColor1: const Color(0xff6d28d9), previewColor2: const Color(0xfffacc15), collection: 'tickets_v173'),
    StoreProduct(id: 'competition_ticket_8000_v173', category: 'competition_ticket', icon: '🎟️', nameAr: 'تذكرة منافسة 8,000 توكن', nameEn: '8,000 Token Competition Ticket', descriptionAr: 'تذكرة دخول للمنافسات حتى قيمة 8,000 توكن. سعر الشراء محدّث ضمن اقتصاد R9.1 مع بقاء قيمة التذكرة المطبوعة ثابتة.', descriptionEn: 'Competition entry ticket worth up to 8,000 tokens, with an R9.1 purchase price while its printed ticket value remains unchanged.', price: 7200, value: '8000', previewColor1: const Color(0xff6d28d9), previewColor2: const Color(0xfffacc15), collection: 'tickets_v173'),
    StoreProduct(id: 'competition_ticket_10000_v173', category: 'competition_ticket', icon: '🎟️', nameAr: 'تذكرة منافسة 10,000 توكن', nameEn: '10,000 Token Competition Ticket', descriptionAr: 'تذكرة دخول للمنافسات حتى قيمة 10,000 توكن. سعر الشراء محدّث ضمن اقتصاد R9.1 مع بقاء قيمة التذكرة المطبوعة ثابتة.', descriptionEn: 'Competition entry ticket worth up to 10,000 tokens, with an R9.1 purchase price while its printed ticket value remains unchanged.', price: 9000, value: '10000', previewColor1: const Color(0xff6d28d9), previewColor2: const Color(0xfffacc15), collection: 'tickets_v173'),
    StoreProduct(id: 'competition_ticket_20000_v173', category: 'competition_ticket', icon: '🎟️', nameAr: 'تذكرة منافسة 20,000 توكن', nameEn: '20,000 Token Competition Ticket', descriptionAr: 'تذكرة دخول للمنافسات حتى قيمة 20,000 توكن. سعر الشراء محدّث ضمن اقتصاد R9.1 مع بقاء قيمة التذكرة المطبوعة ثابتة.', descriptionEn: 'Competition entry ticket worth up to 20,000 tokens, with an R9.1 purchase price while its printed ticket value remains unchanged.', price: 18000, value: '20000', previewColor1: const Color(0xff6d28d9), previewColor2: const Color(0xfffacc15), collection: 'tickets_v173'),
    StoreProduct(id: 'competition_ticket_30000_v173', category: 'competition_ticket', icon: '🎟️', nameAr: 'تذكرة منافسة 30,000 توكن', nameEn: '30,000 Token Competition Ticket', descriptionAr: 'تذكرة دخول للمنافسات حتى قيمة 30,000 توكن. سعر الشراء محدّث ضمن اقتصاد R9.1 مع بقاء قيمة التذكرة المطبوعة ثابتة.', descriptionEn: 'Competition entry ticket worth up to 30,000 tokens, with an R9.1 purchase price while its printed ticket value remains unchanged.', price: 27000, value: '30000', previewColor1: const Color(0xff6d28d9), previewColor2: const Color(0xfffacc15), collection: 'tickets_v173'),
    StoreProduct(id: 'competition_ticket_50000_v173', category: 'competition_ticket', icon: '🎟️', nameAr: 'تذكرة منافسة 50,000 توكن', nameEn: '50,000 Token Competition Ticket', descriptionAr: 'تذكرة دخول للمنافسات حتى قيمة 50,000 توكن. سعر الشراء محدّث ضمن اقتصاد R9.1 مع بقاء قيمة التذكرة المطبوعة ثابتة.', descriptionEn: 'Competition entry ticket worth up to 50,000 tokens, with an R9.1 purchase price while its printed ticket value remains unchanged.', price: 45000, value: '50000', previewColor1: const Color(0xff6d28d9), previewColor2: const Color(0xfffacc15), collection: 'tickets_v173'),
    StoreProduct(id: 'competition_ticket_100000_v173', category: 'competition_ticket', icon: '🎟️', nameAr: 'تذكرة منافسة 100,000 توكن', nameEn: '100,000 Token Competition Ticket', descriptionAr: 'تذكرة دخول للمنافسات حتى قيمة 100,000 توكن. سعر الشراء محدّث ضمن اقتصاد R9.1 مع بقاء قيمة التذكرة المطبوعة ثابتة.', descriptionEn: 'Competition entry ticket worth up to 100,000 tokens, with an R9.1 purchase price while its printed ticket value remains unchanged.', price: 90000, value: '100000', previewColor1: const Color(0xff6d28d9), previewColor2: const Color(0xfffacc15), collection: 'tickets_v173'),
];
...
extension WarqnaV173Controller on AppController {
  ...
  Future<String?> leaveCompetitionV210(String id) async {
    if (!serverConnected) return 'المنافسات تعمل عبر الإنترنت فقط.';
    try {
      final data = await api.leaveCompetitionV210(id);
      if (activeCompetition == id) activeCompetition = null;
      await _save();
      refreshUi();
      final count = int.tryParse(data['exit_count']?.toString() ?? '') ?? 0;
      return count >= 5 ? 'تم الخروج للمرة الخامسة ولن تستطيع العودة إلى هذه المنافسة.' : null;
    } on ApiException catch (e) { return e.message; } catch (_) { return 'تعذر الخروج من المنافسة.'; }
  }
}
...
void showCompetitionsV173(BuildContext context, AppController controller) {
  ...
  showPremiumSheet(context, child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
    ...
    ...competitions.map((entry) => Padding(padding: const EdgeInsets.only(bottom: 9), child: PremiumPanel(child: Padding(padding: const EdgeInsets.all(12), child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
      ...
      Row(children: [Expanded(child: Text('الجائزة حتى ${formatNumber(entry.$4 * entry.$5 ~/ 2)} توكن', style: const TextStyle(color: Colors.lightGreenAccent, fontSize: 10))), FilledButton(onPressed: () async { final active = controller.activeCompetition == entry.$1; final error = active ? await controller.leaveCompetitionV210(entry.$1) : await controller.joinCompetitionV173(entry.$1, entry.$4); if (context.mounted) showToast(context, error ?? (active ? 'تمت مغادرة ${entry.$3}.' : 'تم تسجيلك في ${entry.$3}.')); }, child: Text(controller.activeCompetition == entry.$1 ? 'مغادرة' : 'دخول'))]),
    ]))))),
