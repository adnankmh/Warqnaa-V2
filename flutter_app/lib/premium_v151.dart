...
String authTextV151(String lang, String key) {
  const values = <String, Map<String, String>>{
    'ar': {
      ...
      'create':'إنشاء الحساب', 'secure':'دخول آمن', 'chooseDemo':'اختيار ملف تدريب',
      'fallback':'يمكنك متابعة التدريب بالحساب المحفوظ دون اتصال.', 'orVia':'أو المتابعة عبر',
      'guest':'الدخول كضيف', 'providerNote':'الدخول عبر Google أو Apple أو Facebook يتطلب اتصالاً بالخدمة.',
    ...
    'en': {
      ...
      'create':'Create account', 'secure':'Secure sign in', 'chooseDemo':'Choose a practice profile',
      'fallback':'Continue offline practice with your saved account.', 'orVia':'or continue with',
      'guest':'Continue as guest', 'providerNote':'Google, Apple and Facebook sign-in requires a connection to the service.',
