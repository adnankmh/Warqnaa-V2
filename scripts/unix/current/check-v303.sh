...
python3 tools/test_v303_runtime_premium_contract.py
...
if command -v php >/dev/null 2>&1; then
  ...
  WARQNA_GOLD_MATCHES_PER_ENGINE="${WARQNA_GOLD_MATCHES_PER_ENGINE:-25}" WARQNA_GOLD_MAX_TRANSITIONS="${WARQNA_GOLD_MAX_TRANSITIONS:-160}" php backend-laravel/tools/test-v250-r13-engine-gold.php
...
echo "WARQNAA BUILD 303 CHECK: PASS"
