...
python tools\test_v182_rewards_contract.py || goto :fail
python tools\test_v183_overhaul_contract.py || goto :fail
php backend-laravel\tools\test-v183-engine-overhaul.php || goto :fail
...
exit /b 0
:fail
echo Warqnaa V0.3.3 v184 preflight failed.
exit /b 1
