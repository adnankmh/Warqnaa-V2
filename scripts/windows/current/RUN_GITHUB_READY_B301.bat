...
cd /d "%~dp0\..\..\.."
call scripts\windows\current\CHECK_V301_WINDOWS.bat || exit /b 1
...
git commit -m "Warqnaa v1.1.1+301 CI i18n stability" || echo No new commit was created; continuing.
