...
cd /d "%~dp0\..\..\.."
title Warqnaa Build 303 Verification
echo ================================================
echo      WARQNAA V1.2.0 BUILD 303 - FULL CHECK
echo ================================================
...
echo.
echo WARQNAA V1.2.0 BUILD 303 CHECK: PASS
exit /b 0
:fail
echo.
echo WARQNAA V1.2.0 BUILD 303 CHECK: FAIL
exit /b 1
