...
start "Warqnaa R8 Laravel 8008" cmd /k php artisan serve --host=127.0.0.1 --port=8008
popd
timeout /t 2 /nobreak >nul
start "" http://127.0.0.1:8008
echo.
echo Warqnaa R8 is running:
echo   Website: http://127.0.0.1:8008
echo   Mobile API: http://127.0.0.1:8008/api/mobile/v1
echo   Flutter Web: flutter_app\RUN_FLUTTER_WEB.bat 8008
echo.
pause
