...
cd /d "%~dp0"
title Warqna v156 Launcher

echo ==================================================
echo Warqna v156 - Complete Local Launcher
echo ==================================================

echo [1/4] Validating source package...
set "WARQNA_NO_PAUSE=1"
call CHECK_V156_WINDOWS.bat
if errorlevel 1 (
  set "WARQNA_NO_PAUSE="
  pause
  exit /b 1
...
start "Warqna Backend v156" cmd /k "cd /d ""%~dp0backend-laravel"" && call start-windows.bat"
timeout /t 5 /nobreak >nul

echo [4/4] Starting Flutter Web...
start "Warqna Flutter v156" cmd /k "cd /d ""%~dp0flutter_app"" && call RUN_FLUTTER_WEB.bat"
