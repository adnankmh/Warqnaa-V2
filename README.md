...
الإصدار الحالي: **Build 700**، فوق R6.5 المعتمدة. يضيف تحقق تشغيل معزولًا وحماية بيانات الغرف وحزمة تسليم مرتبطة بالالتزام. راجع `docs/ar/releases/current/START_HERE_V700_AR.md`.
