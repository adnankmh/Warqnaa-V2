# Warqnaa R6.5 — 1.8.0+650

الإصدار الحالي: **Build 650**. مصدر كامل فوق Build 640 مع إصلاحات الغرف والمجموعات ومركز التشغيل ومثبت مرحلي. راجع `docs/ar/releases/current/START_HERE_V650_AR.md` وملف نتائج التحقق المرفق.

ما يلي أرشيف الميزات والإصدارات السابقة؛ المرجع الآلي للإصدار الحالي هو `RELEASE_VERSION.json`.
