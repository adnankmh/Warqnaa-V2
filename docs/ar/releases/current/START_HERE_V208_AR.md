# Warqnaa V0.4.8+208 — R8 Engine Integrity

هذه هي نقطة البدء للإصدار R8.
...
## الفحص
شغّل `CHECK_WARQNA_WINDOWS.bat`. يقوم R8 بفحص الإصدار، العقود، قواعد طرنيب/هاند/بناكل، Stress لجميع المحركات، ثم Playthrough متعدد الحركات. إذا كانت dependencies مثبتة يشغّل Laravel PHPUnit أيضًا.
