# ابدأ من هنا — Warqnaa R6.5 Build 650 — Operations & Release Preparation

> **هذا هو الإصدار الحالي.** مبني على R6.4 Build 640، مع مركز التشغيل وإصلاحات الغرف والمجموعات والتثبيت المرحلي. الأرقام الأقدم أدناه محفوظة كتوثيق تاريخي لعقود التوافق.
...
التفاصيل الكاملة: `docs/ar/releases/current/START_HERE_V650_AR.md`
