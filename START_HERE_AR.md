# ابدأ من هنا — Warqnaa R7 Build 700

نسخة تراكمية فوق R6.5 التي تم اعتمادها في main بعد نجاح الفحوص.

- التشغيل المحلي: `START_WARQNA_WINDOWS.bat`.
- فحص المصدر: `CHECK_WARQNA_WINDOWS.bat`.
- حزمة المثبت: شغّل `INSTALL_WARQNAA_AUTO.bat` بعد استخراجها خارج D:\warq.
- الحساب الموجود والبيانات السابقة تُحفظ أثناء الترقية. بيانات المدير الجديد تُزوّد محليًا عبر البيئة ولا تُضمّن في الحزمة العامة.
- دليل الإصدار وحدود التحقق: `docs/ar/releases/current/START_HERE_V700_AR.md`.
