...
class V175XpChallengesDesignerTest extends TestCase
{
    ...
    public function test_r91_xp_curve_preserves_1_to_79_and_hardens_80_to_100(): void
    {
        ...
        $this->assertSame(4275804, $service->requiredXp(81));
        $this->assertSame(4571144, $service->requiredXp(82));
        $this->assertSame(4888304, $service->requiredXp(83));
        $this->assertSame(5229916, $service->requiredXp(84));
        $this->assertSame(5599012, $service->requiredXp(85));
        $this->assertSame(5999088, $service->requiredXp(86));
        $this->assertSame(6434176, $service->requiredXp(87));
        $this->assertSame(6908944, $service->requiredXp(88));
        $this->assertSame(7428796, $service->requiredXp(89));
        $this->assertSame(9000000, $service->requiredXp(90));
        $this->assertSame(10000000, $service->requiredXp(91));
        $this->assertSame(11100000, $service->requiredXp(92));
        $this->assertSame(12300000, $service->requiredXp(93));
        $this->assertSame(13600000, $service->requiredXp(94));
        $this->assertSame(15000000, $service->requiredXp(95));
        $this->assertSame(16400000, $service->requiredXp(96));
        $this->assertSame(17800000, $service->requiredXp(97));
        $this->assertSame(19000000, $service->requiredXp(98));
