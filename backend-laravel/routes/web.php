...
Route::middleware('auth')->group(function(){
 ...
 Route::post('/account/security/email',[AccountSecurityController::class,'updateEmail'])->middleware('throttle:warqna-sensitive')->name('account.security.email');
 Route::post('/account/security/password',[AccountSecurityController::class,'updatePassword'])->middleware('throttle:warqna-sensitive')->name('account.security.password');
