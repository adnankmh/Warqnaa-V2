...
class DailyPackService
{
    ...
    public static function catalog(): array
    {
        return [
            ...
            ['weight'=>13,'type'=>'player_color','value'=>'#10b981','store_item_key'=>'daily_pack_name_emerald_r305','duration_hours'=>48,'rarity'=>'epic','icon'=>'🎨','label_ar'=>'لون لاعب زمردي ليومين','label_en'=>'Emerald player color for 2 days'],
            ['weight'=>9,'type'=>'xp_booster','value'=>'2.0','store_item_key'=>'daily_pack_xp_2x_r305','duration_hours'=>6,'rarity'=>'legendary','icon'=>'🚀','label_ar'=>'مسرّع خبرة ×2 لمدة 6 ساعات','label_en'=>'XP ×2 for 6 hours'],
