...
class LuckyWheelService
{
    ...
    public static function segments(): array
    {
        ...
        return [
            ...
            ['key'=>'emerald_player','label_ar'=>'لون زمردي','label_en'=>'Emerald Player','icon'=>'🎨','weight'=>7,'color'=>'#065f46','reward'=>['type'=>'player_color','value'=>'#10b981','duration_hours'=>72,'rarity'=>'epic','icon'=>'🎨','label_ar'=>'لون لاعب زمردي لمدة 3 أيام','label_en'=>'Emerald player color for 3 days','store_item_key'=>'lucky_wheel_name_emerald_r305']],
