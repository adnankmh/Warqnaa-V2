...
ok(meta.get('full')=='1.3.0+304','release is exactly 1.3.0+304')
...
ok('b304_table_phoenix' in challenge and 'b304_profile_aurora_30d' in challenge,'challenge road contains staged temporary B304 rewards')
