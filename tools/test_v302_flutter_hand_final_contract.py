...
check(meta.get('full')=='1.1.2+302' and meta.get('release')=='v302','release metadata is 1.1.2+302')
check('version: 1.1.2+302' in read('flutter_app/pubspec.yaml'),'Flutter packages build 302')
