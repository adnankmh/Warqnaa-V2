...
def main() -> None:
    ...
    flutter_main = contains("flutter_app/lib/main.dart", ("part 'r12_competitive.dart';", "R12CompetitiveArenaPage", "R12AdminCompetitivePanel", "TabController(length: 8"), "Flutter navigation and Admin include R12")
